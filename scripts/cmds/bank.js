...
bankData[user].lastInterestClaimed = currentTime;
  ...
  return message.reply("========[Bank]========\The following services are available:\ ❏deposit: Put money into the bank.\❏Withdraw: withdraw money from the bank from your account.\ ❏ show: Show the amount of your bank account.\❏ interest: You get good interest. .\⭓use help bank to know how to use.======================");
} 
}
};